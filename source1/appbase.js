...
export class AppBase {
  ...
  generateBodyJson() {
    ...
    return {
      ...
      onShareTimeline: base.onShareTimeline
    }
  }
  log() {
    console.log("yeah!");
  ...
  onLoad(options) {
    ...
    this.Base.setMyData({ scene: obj.scene })
    console.log(obj);
  ...
  console.log("进没进来")
    memberapi.info({}, (info) => {
      info.start_riqi=this.Base.util.updatetime(info.start_time_dateformat);
      info.end_riqi=this.Base.util.updatetime(info.end_time_dateformat);
      this.Base.setMyData({
        memberinfo: info
      });
    });
  ...
  getUserProfile(){
    ...
    wx.getUserProfile({
      ...
      success: (userres) => {
        ...
        AppBase.UserInfo.city=userres.userInfo.city;
        AppBase.UserInfo.country=userres.userInfo.country;
        AppBase.UserInfo.gender=userres.userInfo.gender;
        AppBase.UserInfo.language=userres.userInfo.language;
        AppBase.UserInfo.nickName=userres.userInfo.nickName;
        AppBase.UserInfo.province=userres.userInfo.province;
        AppBase.UserInfo.avatarUrl=userres.userInfo.avatarUrl;
